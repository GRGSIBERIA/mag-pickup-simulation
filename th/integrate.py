...
# https://stackoverflow.com/questions/42678490/custom-theano-op-to-do-numerical-integration
class Integrate(theano.Op):
    ...
    intZ = Integrate(z,t,0.0,5.0)(x,y)
    ...
    def grad(self,inputs,grads):
        return [Integrate(g,self.t,self.t0,self.tf)(*inputs)*grads[0] \
            for g in self.gradF]
